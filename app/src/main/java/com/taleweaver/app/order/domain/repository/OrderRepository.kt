package com.taleweaver.app.order.domain.repository
...
interface OrderRepository {
    ...
    suspend fun updateOrderStatus(orderId: String, status: com.taleweaver.app.order.domain.model.OrderStatus): Result<Unit>
}
