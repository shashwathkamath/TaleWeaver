package com.taleweaver.app.home.account.presentation
...
import com.taleweaver.app.home.account.domain.usecase.GetUserListingsUseCase
import com.taleweaver.app.home.account.domain.usecase.GetUserProfileUseCase
import com.taleweaver.app.home.account.domain.usecase.LogoutUserUseCase
import com.taleweaver.app.home.account.domain.usecase.UpdateAccountScreen
import com.taleweaver.app.home.account.domain.usecase.UploadProfilePictureUseCase
import com.taleweaver.app.home.feed.domain.model.Listing
import com.taleweaver.app.order.domain.model.Order
import com.taleweaver.app.order.domain.usecase.GetUserPurchasesUseCase
import com.taleweaver.app.order.domain.usecase.GetUserSalesUseCase
...
sealed interface AccountScreenEvent {
    ...
    data class OnShippingAddressChange(val shippingAddress: com.taleweaver.app.order.domain.model.Address) : AccountScreenEvent
    ...
    private fun submitFeedback(feedbackText: String) {
        viewModelScope.launch {
            try {
                ...
                firestore.collection("feedback")
                    ...
                    .addOnSuccessListener {
                        viewModelScope.launch {
                            _eventFlow.emit(
                                UiEvent.ShowSnackbar(
                                    com.taleweaver.app.core.util.Strings.Success.FEEDBACK_SUBMITTED
                                )
                            )
                        }
                    }
                    .addOnFailureListener { exception ->
                        viewModelScope.launch {
                            _eventFlow.emit(
                                UiEvent.ShowSnackbar(
                                    exception.message ?: com.taleweaver.app.core.util.Strings.Errors.UNKNOWN
                                )
                            )
                        }
                    }
                ...
                _eventFlow.emit(
                    UiEvent.ShowSnackbar(
                        e.message ?: com.taleweaver.app.core.util.Strings.Errors.UNKNOWN
                    )
                )
            }
        }
