package com.taleweaver.app.home.presentation
...
import com.taleweaver.app.cart.presentation.CartEvent
import com.taleweaver.app.cart.presentation.CartViewModel
import com.taleweaver.app.core.navigation.AppDestination
import com.taleweaver.app.core.navigation.HomeTabs
import com.taleweaver.app.core.util.UiEvent
import com.taleweaver.app.cart.presentation.CartScreen
import com.taleweaver.app.home.account.presentation.AccountScreen
import com.taleweaver.app.home.account.presentation.UserProfileScreen
import com.taleweaver.app.home.account.presentation.MyListingsScreen
import com.taleweaver.app.home.feed.presentation.FeedScreen
import com.taleweaver.app.home.listingDetail.presentation.screens.ListingDetailScreen
import com.taleweaver.app.home.search.presentation.SearchScreen
import com.taleweaver.app.home.sell.presentation.SellScreen
import com.taleweaver.app.rating.presentation.PostCheckoutRatingScreen
        ...
        NavHost(
            ...
            navigation(
                ...
                composable(
                    ...
                    com.taleweaver.app.home.account.presentation.UserListingsScreen(
                        userId = userId,
            ...
            composable(HomeTabs.Cart.route) {
                ...
                LaunchedEffect(key1 = true) {
                    cartViewModel.checkoutEventFlow.collect { event ->
                        when (event) {
                            is com.taleweaver.app.cart.presentation.CartUiEvent.CheckoutSuccess -> {
                                tabNavController.navigate(HomeTabs.AllTales.route) {
                                    popUpTo(HomeTabs.AllTales.route) { inclusive = true }
                                }
                            }
                            is com.taleweaver.app.cart.presentation.CartUiEvent.CheckoutError -> {
            ...
            composable(AppDestination.POST_CHECKOUT_RATING_SCREEN) {
                val ratingViewModel: com.taleweaver.app.rating.presentation.RatingViewModel = hiltViewModel()
